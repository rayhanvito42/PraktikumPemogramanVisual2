...
def hitung_matriks(mat_a, mat_b):
 ...
 for i in range(0, lebar_matriks(mat_a)):
  for j in range(0, panjang_matriks(mat_a)):
   temp_row.append(mat_a[i][j] + mat_b[i][j]) #symbol + dapat diganti dengan * bila ingin menghitung perkalian,#symbol + dapat diganti dengan - bila ingin menghitung pengurangan 
